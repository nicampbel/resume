...
- LinkedIn: [nicholas-campbell](https://linkedin.com/in/nicholas-campbell)
- GitHub: [nicampbel](https://github.com/nicampbel)


# Education

## Stellenbosch University, MEng (Cum Laude) in Mechatronic Engineering
...
## Stellenbosch University, BEng in Mechatronic Engineering
...
## SpatialEdge, Junior Data Engineer
...
- Databases: BigQuery, PostgreSQL, MongoDB, Firebase, Supabase
- Cloud & Infrastructure: Google Cloud Platform, Apache Airflow, GitLab CI/CD, GitHub Actions, Docker; some experience with AWS & Azure
- Data Engineering: ETL pipeline development, data warehouse optimisation, CI/CD automation
